...
const services = [
  {
    ...
    title: "Meta Ads",
    description:
      "Launch and scale ad campaigns that bring in paying customers — not just likes.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Build a conversion journey from awareness to purchase — and beyond.",
  },
  {
    icon: <Edit3 size={48} className={"text-pink-300"} />,
    title: "Creative & Copy Strategy",
    description:
      "Scroll-stopping visuals + compelling copy that actually sells.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Your ads are only as good as where they land. I guide or optimize your landing pages to increase conversions and reduce drop-offs.",
  },
];
